...
Focus on the core product functionality. Auth flows (login, signup, OAuth) ARE in scope — inspect them and note the auth pattern in `build-spec.md` so the build loop knows what to implement.
